...
Accès à l’interface d’administration : `/admin` (nécessite un utilisateur avec `ROLE_ADMIN`).
...
php bin/console app:import:content resources /path/to/resources.csv --dry-run
```
